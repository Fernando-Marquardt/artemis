...
if ($data[9])
{
	...
	{
	 echo "[ <a class='q_link' href=\"javascript: template('forums.php?town=".$town[0]."&forum=0', '', '')\">".$lang['forum']."</a> ]</br></br>[ <a class='q_link' href='rank_edit.php'>".$lang['editRanks']."</a> ]</br></br>";
