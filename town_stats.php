...
<?php
 ...
 for ($i=$id; (($i<$id+10)&&($i<count($town_stats))); $i++) echo "<tr><td>".$i."</td><td><a class='q_link' href='profile_view.php?id=".$town_stats[$i][1]."'>".stripslashes($town_stats[$i][2])."</a></td><td>".$town_stats[$i][$val]."</td></tr>";
?>
        </table>
...
<?php if (isset($id)) echo "<a class='q_link' href='town_stats.php?town=".$_GET["town"]."&col=".$col."&id=".($id-10)."'><<</a> | <a class='q_link' href='town_stats.php?town=".$_GET["town"]."&col=".$col."&id=".($id+10)."'>>></a>"; ?>
		</td>
      </tr>
      <tr>
