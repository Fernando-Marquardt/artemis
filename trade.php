...
{
 $_GET["town"]=clean($_GET["town"]); $_GET["type"]=clean($_GET["type"]); $_POST["name"]=clean($_POST["name"]); $_POST["sQ"]=abs(clean($_POST["sQ"])); $_POST["sType"]=clean($_POST["sType"]); $_POST["sSubType"]=clean($_POST["sSubType"]); $_POST["maxTime"]=clean($_POST["maxTime"]);
 check_r($_GET["town"]);
