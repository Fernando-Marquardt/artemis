...
<?php echo $top_ad; ?>
    <table class="q_table">
	  ...
	  <a class='q_link' href='send_to_all.php'><?php echo $lang['sendToAll'] ?></a> | 
	  <a class='q_link' href='del_u.php'><?php echo $lang['deleteUser'] ?></a> | 
	  <a class='q_link' href='check_d_all.php'><?php echo $lang['checkDelQueue'] ?></a> | </br>
	  <a class='q_link' href='clean_u.php'><?php echo $lang['cleanIdle'] ?></a> | 
	  <a class='q_link' href='level.php'><?php echo $lang['userLevel'] ?></a> | 
	  <a class='q_link' href='g_points.php'><?php echo $lang['givePoints'] ?></a> | 
	  <a class='q_link' href='chat_s.php'><?php echo $lang['chatRooms'] ?></a> | </br>
			<a class='q_link' href='clean_forums.php'><?php echo $lang['cleanForums'] ?></a> | 
        </td>
      </tr>
      <tr>
