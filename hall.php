...
<?php for ($i=0; $i<count($buildings); $i++)
                   if ((!$c_status[$i])&&(!$data[$i]))
                   {
                     ...
                     $okreq=1; $ok=1;
                         ...
                         $tag="<a class='q_link' href='build.php?town=".$town[0]."&b=".$buildings[$i][0]."&subB=-1'>".$lang['build']." ".$name[0]."</a></br>".$buildings[$i][8]."</br>".$lang['req'].": ";
...
</table><script type='text/javascript'>ch_a(document.getElementById('a').selectedIndex)</script>
