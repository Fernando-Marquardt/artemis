...
if (!isset($_GET["v"]))
{
  if (isset($_SERVER['HTTP_USER_AGENT']) && (strpos($_SERVER['HTTP_USER_AGENT'], 'MSIE') !== false)) $mleft=0; else $mleft=125;
  echo "<div style='position:relative; top:0; left:".$mleft."; cursor:url(".$imgs.$fimgs."cursor.png), auto;'><img src='".$imgs.$fimgs."x.gif'>
