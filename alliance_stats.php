...
if (isset($col))
{
 for ($i=$id; (($i<$id+10)&&($i<count($alliance_stats))); $i++) echo "<tr><td>".$i."</td><td><a class='q_link' href='a_view.php?id=".$alliance_stats[$i][0]."'>".$alliance_stats[$i][1]."</a></td><td>".$alliance_stats[$i][2]."</td></tr>";
}
?>
        </table>
